...
data,  that can be passed between React components<--


## state update, 
## type security errors,
## react elementRef (class based component and func based component),
## context API- data bypassing between React components A to D insed a to b to c to D -
## context API-  
(data passing between React components
using AuthContext value, AuthContext.Consumer, class based components [static contextType], for functional
based components [useContext react hook])
